        ...
        <div className="space-y-10 animate-fade-in max-w-4xl mx-auto py-10">
            <div className="bg-slate-900 border border-white/10 rounded-[3.5rem] p-12 shadow-[0_0_100px_rgba(0,0,0,0.5)] group relative overflow-hidden backdrop-blur-xl">
                ...
                <h3 className="text-2xl font-black text-white uppercase tracking-tighter italic mb-10 flex items-center gap-5">
                    ...
                    Protocolos de Disponibilidad Estratégica
                </h3>
                ...
                <div className="bg-slate-950/60 p-10 rounded-[2.5rem] border border-white/5 flex flex-col md:flex-row justify-between items-center gap-10 hover:bg-slate-950/80 transition-all duration-700 shadow-inner group/item relative z-10">
                    <div className="space-y-4 text-center md:text-left flex-1 h-full">
                        <div className="flex items-center gap-3 justify-center md:justify-start">
                            <h4 className="text-lg font-black text-white uppercase tracking-widest italic group-hover/item:text-yellow-500 transition-colors">Modo de Contingencia / Mantenimiento</h4>
                        ...
                        <p className="text-[11px] text-gray-500 font-black leading-relaxed max-w-lg uppercase tracking-[0.2em] italic opacity-60 group-hover/item:opacity-100 transition-opacity">
                            Restringe el acceso total a la infraestructura académica. 
                            Las conexiones de usuarios no administrativos serán interceptadas y redirigidas a la capa de contingencia v3.0.
                        </p>
                    </div>
                ...
                <div className="mt-12 p-10 bg-yellow-500/5 rounded-[2.5rem] border border-yellow-500/10 flex gap-8 items-center backdrop-blur-md group-hover:bg-yellow-500/10 transition-all duration-700">
                    <div className="w-16 h-16 bg-yellow-500/10 rounded-[1.5rem] flex items-center justify-center text-yellow-500 border border-yellow-500/20 shrink-0 shadow-2xl group-hover:scale-110 transition-transform duration-700">
                        <ShieldAlert className="w-10 h-10" />
                    </div>
                    <div className="space-y-2">
                        <h5 className="text-[11px] font-black text-yellow-500 uppercase tracking-[0.3em] italic">Advertencia Crítica de Infraestructura v4.0</h5>
                        <p className="text-[10px] text-gray-400 font-bold leading-relaxed italic uppercase tracking-[0.2em] max-w-2xl">
                            Al activar el protocolo de mantenimiento, todas las operaciones de gamificación, reporteo y aprendizaje quedarán congeladas. 
                            Este procedimiento debe ser validado por el <span className="text-white brightness-125 font-black underline decoration-yellow-500/40 underline-offset-4">Director de TI</span> antes de su ejecución para evitar colisiones de datos.
                        </p>
                    </div>
                </div>
            </div>
