                ...
                <div className="flex flex-col sm:flex-row items-center justify-between px-6 py-4 bg-slate-900/40 rounded-2xl border border-white/5 gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="relative">
                            <button
                                ...
                                className="flex items-center gap-2 bg-slate-800/80 border border-white/10 hover:border-white/20 text-white text-xs font-black rounded-lg px-3 py-1.5 transition-all outline-none min-w-[65px] justify-between uppercase"
                            >
                            ...
                            {isPerPageOpen && (
                                <>
                                    ...
                                    <div className="absolute bottom-full left-0 mb-2 w-full min-w-[80px] z-50 bg-slate-800 border border-white/10 rounded-xl overflow-hidden shadow-2xl backdrop-blur-xl">
                                        {[10, 20, 50, 100, 9999].map(val => (
                                            <button
                                                ...
                                                className={`w-full text-center px-2 py-2.5 text-[10px] font-black uppercase transition-colors ${itemsPerPage === val ? 'bg-primary-500 text-white' : 'text-gray-400 hover:bg-white/5 hover:text-white'}`}
                                            >
                                                {val > 500 ? 'TODOS' : val}
                                            </button>
                                        ))}
                    ...
                    <div className="flex items-center gap-3 md:gap-6">
                        <button
                            ...
                            className="p-2 rounded-xl text-gray-500 hover:bg-slate-800 hover:text-white transition-colors disabled:opacity-10 disabled:pointer-events-none flex items-center gap-2"
                        ...
                        <div className="text-[10px] font-black text-gray-400 uppercase tracking-widest min-w-[60px] text-center">
